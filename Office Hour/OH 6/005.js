...
function highestTopSpeed(data) {
  ...
  let temp = splitterArr(data, ",");
  let maxSpeed="";
  for(let i = 0; i < temp.length; i++){
    let name_speed = splitterArr(temp[i], ":");
    let speed = splitterArr(name_speed[1], " ");

    maxSpeed = maxSpeed < speed[0] ? speed[0] : maxSpeed;
  }
